...
function savePixels(data) {
  ...
  const utmify = Array.isArray(raw.utmify) ? raw.utmify : (Array.isArray(data?.utmify) ? data.utmify : []);
  const facebook = Array.isArray(raw.facebook) ? raw.facebook : (Array.isArray(data?.facebook) ? data.facebook : []);
  const tiktok = Array.isArray(raw.tiktok) ? raw.tiktok : (Array.isArray(data?.tiktok) ? data.tiktok : []);
